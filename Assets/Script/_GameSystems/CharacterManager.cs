...
public class CharacterManager : MonoBehaviour
{
   ...
   public Vector3 characterOffset = new(0f, 1f, 0f);

   public float Camera2CharacterDistance;
   ...
   ///    获取摄像机与角色特定点的距离
   /// </summary>
   public float GetCameraToPointDistance(Vector3 localOffset)
   {
      if (CurrentCharacter == null || mainCamera == null) return 0f;
      var worldPoint = CurrentCharacter.transform.TransformPoint(localOffset);
      return Vector3.Distance(worldPoint, mainCamera.transform.position);
   }
